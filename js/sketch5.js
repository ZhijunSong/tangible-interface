...
function setup() {
  ...
  springs[0] = new Spring(10,10, 40, 0.98, 8.0, 0.1, springs, 0);
  springs[1] = new Spring(20,100, 120, 0.95, 9.0, 0.1, springs, 1);
  springs[2] = new Spring(40,50, 170, 200, 0.90, 9.9, 0.1, springs, 2);
}
